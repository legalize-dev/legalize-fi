...
status: "repealed"
source: "https://www.finlex.fi/fi/laki/ajantasa/2022/20220966"
department: "Valtiovarainministeriö"
eli: "http://data.finlex.fi/eli/sd/2022/966/ajantasa"
...
5) vastaa tehtäväalueelleen kuuluvasta kansainvälisestä tietojenvaihdosta, virka-avusta sekä muista kansainvälisiin sopimuksiin tai EU-lainsäädäntöön perustuvista velvoitteista ja tehtävistä; ja

6) vastaa Verohallinnon laatutoimen kehittämisestä ja ohjauksesta sekä laadun arvioinnista yhteistyössä muiden yksiköiden kanssa, lukuun ottamatta 20 §:n 5 kohdassa tarkoitettuja laadunvarmistustehtäviä ja -menettelyjä.
...
6) vastaa julkisen hallinnon tiedonhallinnasta annetun lain 
                                    [(906/2019) 6 a luvussa](/akn/fi/act/statute-consolidated/2019/906#chp_6a)
                                     säädetyistä tehtävistä ja tekee lain 28 d §:ssä tarkoitetut automaattisten toimintaprosessien käyttöönottopäätökset;
...
##### 30 § Turvallisuus- ja riskienhallintayksikön tehtävät
...
4) vastaa konserniriskien tilannekuvan muodostamisesta strategiaprosessille;

5) vastaa Euroopan unionin ja kansallisen oikeuden rikkomisesta ilmoittavien henkilöiden suojelusta annetun lain sekä direktiivin (EU) 2019/1937 mukaisten ilmoitusten käsittelystä; ja

6) raportoi riskienhallinnan ja turvallisuuden asioista pääjohtajalle ja johtoryhmälle säännöllisesti, valmistelee pääjohtajan ratkaistavaksi turvallisuuteen ja riskienhallintaan liittyvät periaatteellisesti merkittävät asiat sekä ilmoittaa viipymättä välittömiä toimenpiteitä vaativat asiat pääjohtajalle ja asianomaiselle yksikölle.

##### 31 § Turvallisuus- ja riskienhallintayksikön organisaatio

Turvallisuus- ja riskienhallintayksikössä ei ole toimintayksiköitä.

##### 32 § Sisäisen tarkastuksen yksikön tehtävät

Sisäinen tarkastus vastaa Verohallinnon sisäisestä tarkastuksesta.

##### 33 § Sisäisen tarkastuksen yksikön organisaatio

Sisäisen tarkastuksen yksikössä ei ole toimintayksiköitä.

##### 34 § Harmaan talouden selvitysyksikön tehtävät

Harmaan talouden selvitysyksikkö käsittelee sen tehtäväksi säädetyt tai erikseen määrätyt tehtävät.

##### 35 § Harmaan talouden selvitysyksikön organisaatio

Harmaan talouden selvitysyksikössä ei ole toimintayksiköitä.

##### 36 § Tulorekisteriyksikön tehtävät

Tulorekisteriyksikkö käsittelee sen tehtäväksi säädetyt tai erikseen määrätyt tehtävät.

##### 37 § Tulorekisteriyksikön organisaatio
...
##### 38 § Pääjohtajan ratkaistavat asiat
...
##### 39 § Virkojen sijoittaminen, virkavapaudet ja eräät muut virkoja koskevat päätökset
...
##### 40 § Hallintokanteluiden ratkaiseminen
...
##### 41 § Tiedottaminen pääjohtajalle
...
##### 42 § Verotustietojen luovuttaminen
...
##### 45 § Tehtäväjaon määräytyminen eräissä tapauksissa
...
##### 46 § Turvallisuuden hallinta

Turvallisuuden, riskienhallinnan ja varautumisen toimintaperiaatteet, tavoitteet toiminnalle ja toiminnasta merkittävissä häiriötilanteissa määrää pääjohtaja. Pääjohtajan tukena toimii Turvallisuus- ja riskienhallintayksikkö, joka valmistelee, ohjaa, seuraa ja kehittää Verohallinnon toiminnan turvallisuutta ja varautumista sekä häiriötilanteiden palautumiskyvykkyyttä.

Verohallinnon yksiköt vastaavat turvallisuuteen liittyvien asioiden seurannasta, raportoinnista ja kehittämisestä sekä turvallisuusriskien ja -häiriöiden arvioinnista ja hallinnasta yhteistyössä Turvallisuus- ja riskienhallintayksikön kanssa. Yksiköt ilmoittavat havaitsemansa turvallisuuteen liittyvät puutteet, riskit ja kehittämistarpeet Turvallisuus- ja riskienhallintayksikölle.

##### 47 § Soveltaminen työsuhteiseen henkilöstöön
...
Tämä työjärjestys tulee voimaan 1.1.2023.

Tällä työjärjestyksellä kumotaan 7.12.2021 (VH/5054/00.02.02.01/2021, SDK 1086/2021) annettu Verohallinnon työjärjestys.
